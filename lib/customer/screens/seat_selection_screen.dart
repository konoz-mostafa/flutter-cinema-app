...
class _SeatSelectionScreenState extends State<SeatSelectionScreen> {
  ...
  Future<void> _fetchCurrentBookings() async {
    final bookings = await AppState.getBookings(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Wrap(
                      ...
                      children: [
                        _buildLegend('Available', Colors.white, Icons.event_seat_outlined),
                        _buildLegend('Your Selection', Colors.green.shade500, Icons.check_circle),
